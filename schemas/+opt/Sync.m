%{
opt.Sync (imported) # synchronization of optical movie with visual stimulus
...
classdef Sync < dj.Relvar & dj.AutoPopulate
    ...
    methods(Access=protected)
        ...
        function makeTuples(self, key)
            ...
            [movie, ~, phd, phdFs] = opt.utils.getOpticalData(getLocalPath(filename));
            [times, psyId] = trove.FlipCode.synch(phd, phdFs, psy.Trial(key));
