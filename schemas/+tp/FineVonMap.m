%{
tp.FineVonMap (computed) # my newest table
-> tp.FineOriMap
...
classdef FineVonMap < dj.Relvar & dj.AutoPopulate
    
    properties(Constant)
        table = dj.Table('tp.FineVonMap')
        popRel = tp.FineOriMap
    end
    ...
    methods(Access=protected)
        ...
        function makeTuples(self, key)
            ...
            [B, R2, dof, C] = fetch1(tp.FineOriMap*tp.OriDesign & key, ...
