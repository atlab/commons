...
uicontrol('style','text','string','DOA','position',[430 900 90 16],'fontsize',14);
...
uicontrol('style','text','string','Line','position',[1048 900 166 16],'fontsize',14);
uicontrol('style','text','string','Genotype','position',[1219 900 135 16],'fontsize',14);
...
uicontrol('style','text','string','Source','position',[573 830 388 16],'fontsize',14);
uicontrol('style','text','string','Notes','position',[966 830 388 16],'fontsize',14);
...
h.doa = uicontrol('style','edit','position',[430 865 90 35],'fontsize',14,'tag','doaField');
...
h.source = uicontrol('style','edit','position',[573 795 388 35],'fontsize',14,'HorizontalAlignment','left','tag','sourceField');
h.mouse_notes = uicontrol('style','edit','position',[966 795 388 35],'fontsize',14,'HorizontalAlignment','left','tag','notesField');
...
h.add = uicontrol('style','pushbutton','string','+','position',[50 710 25 25],'fontsize',18,'backgroundcolor','g','Callback',@mice.GUIs.plusFounderCallback);
...
h.submit = uicontrol('style','pushbutton','string','Submit Founder(s) to Database','position',[524 10 256 50],'fontsize',16,'Callback',@mice.GUIs.submitFounder,'tag','submitFounderButton');
