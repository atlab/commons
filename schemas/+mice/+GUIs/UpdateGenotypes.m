...
h.find = uicontrol('style','pushbutton','position',[50 370 110 29],'fontunits','normalized','fontsize',.4,'string','Find Mice','HorizontalAlignment','Center','Callback',@mice.GUIs.findMice);
...
h.submitGenotypes = uicontrol('style','pushbutton','string','Update Genotypes','position',[350 10 200 50],'fontunits','normalized','fontsize',.35,'Callback',@mice.GUIs.submitGenotypes);