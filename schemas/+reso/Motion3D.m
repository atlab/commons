%{
reso.Motion3D (imported) # motion in 3D computed from a ministack
-> reso.MiniStack
-----
...
classdef Motion3D < dj.Relvar & dj.AutoPopulate
    ...
    properties
        popRel = reso.MiniStack & 'stack is not null';
    end
    ...
    methods(Access=protected)
        ...
        function makeTuples(self, key)
            ...
            [stack,zstep] = fetch1(reso.MiniStack & key,'stack','zstep');
            ...
            while ~reader.done
                ...
                block = reso.Align.correctMotion(block, xymotion(:,:,lastPos+(1:sz(4))));
    ...
    methods
        function plot(self)
            for key = self.fetch'
                clf
                [times,x,y,z] = fetch1(reso.Sync*reso.Motion3D & key, ...
