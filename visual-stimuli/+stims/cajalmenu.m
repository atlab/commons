...
madmax = struct( ...
    ...
    setParams(stims.MovieClip, psy.MovieClipCond, ...
    'movie_name', 'MadMax', ...
    'clip_number', 1:110, ... 
    'cut_after', 60 ...
    ) 
...
s = RandStream('mt19937ar','Seed','shuffle');
madseq = struct( ...
    'prompt', 'MadSeq (120 mins)', ...
    'logger', logger(), ...
    'constants', setfield(constants, 'stimulus', 'madseq'), ...
    'blocks', 1, ...
    'stim', {{
    ...
    setParams(stims.MovieStill, psy.MovieStillCond, ...
    'movie_name', 'MadMax', ...
    'pre_blank_period', 0, ...
    'duration', 0.5, ...
    'still_id', 1:2:12000 ...
    ...
    setParams(stims.MovieSeq, psy.MovieSeqCond, ...
    'movie_name', 'MadMax', ...
    'rng_seed', repmat([1 2], 30, 1), ...
    'pre_blank_period', 0, ...
    'duration', 0.5, ...
    'seq_length', 20 ... 
    )
