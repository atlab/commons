...
madmax = struct( ...
    ...
    'blocks', 1, ...
    'stim', {{
    setParams(stims.Movie, psy.Movie, ...
    'clip_number', 1:110, ... 
    'path_template', '/home/atlab/MadMax/madmax_%03u.avi', ...
    'cut_after', 60 ...
    ), ...
    setParams(stims.Movie, psy.Movie, ...
    'clip_number', sort(repmat(randperm(s,110,2),1,30)), ... 10 sec each
    'path_template', '/home/atlab/MadMax/madmax_%03u.avi', ...
    'cut_after', 10 ...
    )
    }});   %#ok<SFLD>
...
movies3D = struct( ...
    ...
    setParams(stims.Movie, psy.Movie, ...
    'clip_number', 1:710, ... 
    'path_template', '/home/atlab/movies3D/obj1_%04u.avi', ...
    'cut_after', 5 ...
    ), ...
    setParams(stims.Movie, psy.Movie, ...
    'clip_number', 1:710, ... 
    'path_template', '/home/atlab/movies3D/obj2_%04u.avi', ...
    'cut_after', 5 ...
    )
    }});   %#ok<SFLD>
