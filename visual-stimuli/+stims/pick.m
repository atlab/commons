...
menu = {% menu-item    callback
    ...
    %'grating: in one spot (480 s)'                setParams(stims.Grating, 30, 'pre_blank', 6, 'trial_duration', 4.0, 'direction', [90 180], 'aperture_radius', 0.3, 'aperture_x', -.4, 'aperture_y',-.4, 'spatial_freq',.08,'temp_freq',1)
