...
menu = {% menu-item    callback
    ...
    'grating: 1s ON/1s OFF (384 s), multiple TF,SF' setParams(stims.Grating, 15, 'direction', [0 90], 'pre_blank', 1.0, 'trial_duration', 1.0, 'aperture_radius', 0.63, 'spatial_freq',[.02 .04 .08 .12 .16],'temp_freq',[2 4 6 8 10],'grating','sqr')
