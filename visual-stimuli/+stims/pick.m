...
menu = {% menu-item    callback
    ...
    %'grating: in one spot (800 s)'                setParams(stims.Grating, 30, 'pre_blank', 6, 'trial_duration', 4.0, 'direction', [90 180], 'aperture_radius', 0.2, 'aperture_x', 0, 'aperture_y',0, 'spatial_freq',.046,'temp_freq',0.87)
    'grating: 1s ON/1s OFF (384 s), multiple TF,SF' setParams(stims.Grating, 10, 'direction', 0:60:359, 'pre_blank', 1.0, 'trial_duration', 1.0, 'aperture_radius', 0.63, 'spatial_freq',[.04 .08 .16 .32],'temp_freq',[2 4 8 16])
