classdef Picker
    ...
    properties(Constant)
        ...
        menu = {% menu-item    callback
            ...
            %'grating: in one spot (480 s)'              setParams(stims.Grating, 6, 'pre_blank', 6, 'trial_duration', 4.0, 'direction', 0:90:359, 'aperture_radius', 0.2, 'aperture_x', 0, 'aperture_y',0, 'temp_freq',2)
            ...
            'moving bar: black on white (384 s)'      setParams(stims.MovingBar, 12, 'luminance', 5, 'contrast', 0.95, 'bg_color', 254, 'bar_color', 0, 'trial_duration', 4)
